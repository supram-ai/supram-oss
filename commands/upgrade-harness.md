...
actions:
  ...
  - adopt_paid_offering:
    - when the user adopts the paid product, hand .supram-oss/ state to the Supram CLI (hasp-cli)
    - hasp-cli performs the state migration from .supram-oss/ to .supram/ (see MIGRATION.md)
